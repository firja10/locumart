...
<div id="profil_pribadi" class="tabcontent row" style = "padding:40px; background-color:#FBE177" >
  ...
  <form method="POST" enctype="multipart/form-data" action = "{{route('updatetoko', $tokos->id)}}" >
    @method('PATCH')
        ...
        <tr>
          <td style = "padding:15px; text-align:left;"> 
            ...
            <input type="file" class = "form-control" placeholder = "Ganti Gambar" > --}}
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukkan Nama" style = "background-color: #FBE177; border-color:#2C3764; font-size:10px; font-weight:bold;" value = "{{$tokos->name}}">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Alamat" style = "background-color: #FBE177; border-color:#2C3764 ; font-size:10px; font-weight:bold;" value = "{{$tokos->alamat}}">  
              </div>
          ...
          <td style = "padding:15px; text-align:left;"> 
              ...
              <div class="form-group">
                ...
                <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukkan Nama" style = "background-color: #FBE177; border-color:#2C3764; font-size:10px; font-weight:bold; " value = "{{$tokos->email}}">
              </div>
              ...
              <div class="form-group">
                ...
                <select name="tempat_lahir" id="" class = "form-control" style = "background-color: #FBE177; border-color:#2C3764; font-size:10px; font-weight:bold;" >
          ...
          <td style = "padding:15px; text-align:left;"> 
            <div class="form-group">
              ...
              <input type="date" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Tanggal Lahir" style = "background-color: #FBE177; border-color:#2C3764; font-size:10px; font-weight:bold; width:110%;" value = "{{$tokos->tanggal_lahir}}">
            </div>
           ...
           <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nomor Rekening" style = "background-color: #FBE177; border-color:#2C3764; font-size:10px; font-weight:bold; width:110%;" value = "{{$tokos->nomor_rekening}}">
              </div>
        ...
        <td style = "padding:15px; text-align:left;"> 
          ...
          <form>
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukkan Nama" style = "background-color: #FBE177; border-color:#2C3764; font-size:10px; font-weight:bold;" value = "{{$tokos->nama_toko}}">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Alamat" style = "background-color: #FBE177; border-color:#2C3764 ; font-size:10px; font-weight:bold;" value = "{{$tokos->alamat_perusahaan}}" name = "alamat_perusahaan">  
            </div>
