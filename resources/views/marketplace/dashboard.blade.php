...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="#page-top">LOCUMART</a>
        ...
        <!-- Masthead-->
        {{-- <header class="masthead text-white text-center" style = "background:url('/marketplace/dashboard.png') ;">
        ...
        <section id = "hero" style = "background:url('/marketplace/dashboard.png'); background-size:cover;">
